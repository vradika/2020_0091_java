...
public class Ex02_main {
	public static void main(String[] args) {
		...
		// API에서 제공하는 Random클래스의 nextInt()와 nextInt(int bound), nextDouble()를 사용하는 예이다.
		
		// nextInt()와 nextInt(int bound), nextDouble() 들은 static이 아니므로 클래스를 객체로 만들어서 사용해야 한다.
		...
		// Math 클래스의 메소드들은 static이므로 객체 생성 없이 사용가능
