...
public class Ex02 {
	public static void main(String[] args) {
		...
		// 11. 	contains(String s): boolean, 인자에 char는 오류, 대소문자 구별함
		...
		// 13. split(String regex, int limit): String[]
		...
		//		시작위치부터 끝까지 문자열 추출
		// 14. substring(int beginIndex, int endIndex): String
		//		시작위치부터 끝위치 전까지 문자열 추출
		String str17 = "010-123-4567";
		
		String msg = str17.substring(4);
		System.out.println(msg);
		System.out.println("============================");
		
		msg = str17.substring(8, 12);
		System.out.println(msg);
		System.out.println("============================");
		...
		// 퀴즈: 010-7777-9999를 => 010-7777-XXXX
		String str01 = "010-7777-9999";
		System.out.println(str01);
		str01 = str01.replace("010-7777-9999", "010-7777-XXXX");
		System.out.println(str01);
		System.out.println("============================");
		
		// 15. toLowerCase(): String 모든 대문자를 소문자로 변경시킨다.
		// 16. toUpperCase(): String 모든 소문자를 대문자로 변경시킨다.
		...
		//						문자열로 만들어 리턴하는 메소드(오버라이딩할 때 배운다.)
		...
		// 20. Wrapper class:
		// - 각종 자료형의 형태를 가진 문자열을 진짜 자료형으로 변경시키는 클래스들.
		...
		// 20 - 4. 문자열을 float형으로 변경: Float.parse.Float
		// "숫자" => "숫자f" => X
		message = "3.14f";
		...
		// 	   - 모든 문자 사용 가능(getVytes()는 영어와 숫자만 가능)
